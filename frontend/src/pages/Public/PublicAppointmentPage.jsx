...
//         {/* RIGHT SIDE: STATUS & HELP (Sidebar) */}
//         <div className="w-full lg:w-[420px] bg-gradient-to-b from-slate-900 to-slate-800 lg:h-full p-8 lg:p-10 text-white overflow-y-auto">
...
//                     className="w-full bg-white/10 border-2 border-transparent focus:border-blue-500 rounded-xl px-4 py-4 pl-12 text-white placeholder:text-white/30 focus:ring-0 outline-none transition-all"
//                     value={searchId}
//                     onChange={(e) => setSearchId(e.target.value)}
//                   />
//                   <Search className="absolute left-4 top-4 text-white/30" size={18} />
//                 </div>
                
//                 <button 
//                   onClick={() => dispatch(fetchAppointmentStatus(searchId))}
//                   disabled={statusLoading}
//                   className="w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold py-4 rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all shadow-lg shadow-blue-500/20 flex items-center justify-center gap-2"
//                 >
//                   {statusLoading ? (
...
//               {appointmentStatus && (
//                 <div className="mt-6 p-6 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-2xl border border-blue-500/30 animate-in fade-in zoom-in-95">
//                   <div className="flex items-center gap-3 mb-4">
//                     <div className="w-10 h-10 rounded-full bg-blue-500/30 flex items-center justify-center">
//                       <CheckCircle className="text-blue-400" size={20} />
//                     </div>
//                     <div>
//                       <p className="text-xs font-bold text-blue-400 uppercase tracking-wider">Appointment Found</p>
//                       <p className="text-sm font-mono">{appointmentStatus.appointmentId}</p>
//                     </div>
//                   </div>
...
//                       <span className="font-bold text-white">{appointmentStatus.service?.name}</span>
//                     </div>
...
//                       <span className="font-bold text-white">{appointmentStatus.customer?.fullName}</span>
//                     </div>
                    
//                     <div className="flex justify-between items-center py-2">
//                       <span className="text-slate-400 text-sm">Status</span>
//                       <span className={`px-4 py-1.5 rounded-full text-xs font-black uppercase tracking-wider ${
//                         appointmentStatus.status === 'CONFIRMED' ? 'bg-green-500/20 text-green-400 border border-green-500/30' :
//                         appointmentStatus.status === 'PENDING' ? 'bg-yellow-500/20 text-yellow-400 border border-yellow-500/30' :
...
//               {error && (
//                 <div className="mt-4 p-4 bg-red-500/20 rounded-xl border border-red-500/30 flex items-center gap-2">
...
//                 United States
//               </p>
//               <div className="mt-4 h-24 bg-slate-700 rounded-xl overflow-hidden">
//                 {/* Map placeholder - you can embed actual map here */}
...
//             {/* INFO CARDS */}
//             <div className="space-y-4">
//               <div className="flex gap-4 p-4 bg-white/5 rounded-2xl backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-all">
//                 <div className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center text-blue-400 flex-shrink-0">
//                   <ShieldCheck size={22} />
//                 </div>
//                 <div>
//                   <h4 className="font-bold text-sm mb-1">Secure Booking</h4>
//                   <p className="text-xs text-slate-400 leading-relaxed">Your data is encrypted and handled with high confidentiality standards.</p>
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <h4 className="font-bold text-sm mb-1">Flexible Payment</h4>
//                   <p className="text-xs text-slate-400 leading-relaxed">Pay at the venue or online with multiple payment options.</p>
//                 </div>
//               </div>
...
//                 </div>
//                 <div>
//                   <h4 className="font-bold text-sm mb-1">SMS Reminders</h4>
//                   <p className="text-xs text-slate-400 leading-relaxed">Get notified 24 hours before your appointment.</p>
//                 </div>
//               </div>
//             </div>
//           </div>
