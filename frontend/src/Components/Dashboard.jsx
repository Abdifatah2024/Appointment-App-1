...
//       data = data.filter((a) => new Date(a.appointmentDate) >= lastMonth);
//     }

//     if (timeFilter === "LAST_YEAR") {
//       const lastYear = new Date();
//       lastYear.setFullYear(now.getFullYear() - 1);
//       data = data.filter((a) => new Date(a.appointmentDate) >= lastYear);
//     }
...
//     // Position fixed to be inside the ring
...
//     XLSX.writeFile(
//       wb,
//       `Dashboard_Report_${new Date().toLocaleDateString()}.xlsx`,
//     );
//   };
...
//                   {selectedAppointment.assignedUserId?.fullName ||
//                     "Not Assigned"}
//                 </p>
//               </div>
...
//         {/* KPI CARDS - MERGED FROM CODE 1 & 2 */}
...
//         {/* ACTIVITY TABLE - UPDATED WITH STAFF FROM CODE 2 */}
...
//                     {/* STAFF COLUMN DATA (using assignedUserId from Code 2) */}
//                     <td className="px-8 py-5">
